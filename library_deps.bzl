...
BATFISH_MAVEN_ARTIFACTS = [
    ...
    maven.artifact(group = "org.glassfish.jersey.test-framework.providers", artifact = "jersey-test-framework-provider-grizzly2", version = "3.1.5", exclusions = [maven.exclusion(group = "junit", artifact = "junit")]),
